...
export const domainMetadata: Record<IconDomain, DomainMetadata> = {
  ...
  biology: {
    ...
    iconCount: biologyIcons.length + molecularIcons.length + geneticsIcons.length + ecologyIcons.length + microbiologyIcons.length + zoologyIcons.length + botanyIcons.length + cellbiologyIcons.length + neuroscienceIcons.length + environmentalIcons.length + oceanographyIcons.length + agricultureIcons.length + anatomyIcons.length,
    color: '#22c55e', // Green
  },
  chemistry: {
    id: 'chemistry',
...
export function getIconStats(): {
  ...
  return {
    ...
    byDomain: {
      ...
      biology: biologyIcons.length + molecularIcons.length + geneticsIcons.length + ecologyIcons.length + microbiologyIcons.length + zoologyIcons.length + botanyIcons.length + cellbiologyIcons.length + neuroscienceIcons.length + environmentalIcons.length + oceanographyIcons.length + agricultureIcons.length + anatomyIcons.length,
